...
{
    class AutomaticRifleman : Infantry
    {
        public AutomaticRifleman(string name, string rank, Weapon weapon = null, Soldier supervisor = null) : base (name, rank, weapon, supervisor)
        {
            this.Name = name;
            this.Rank = rank;
            this.Weapon = weapon;
